    ...
    store_proposed_(false)
{
    ...
    get_ = boost::bind(&VectorAdapter::get, a_p, bph::_1, bph::_2);
    set_ = boost::bind(&VectorAdapter::set, a_p, bph::_1, bph::_2, bph::_3);
    size_ = boost::bind(&VectorAdapter::size, a_p, bph::_1);
}
...
(
    ...
    get_(boost::bind<double>(vector_get<Model>, bph::_1, bph::_2)),
    set_(boost::bind<void>(vector_set<Model>, bph::_1, bph::_2, bph::_3)),
    size_(boost::bind(&Model::size, bph::_1)),
    log_target_(log_target),
    gradient_(gradient),
    step_sizes_(step_sizes),
...
) const
{
    ...
    for_each(
        recorders_.begin(),
        recorders_.end(),
        boost::bind(&record_t::operator(), bph::_1, *this, q, lt_q));
        */
}
