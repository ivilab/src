/* $Id: gsl_special_fun.c 25499 2020-06-14 13:26:04Z kobus $ */
...
static int test_bessel_i0(void)
{
    ...
    /* I0(0) = 1 */
    ERE(ivi_bessel_I0(&y, 0));
    ERE(pretty_close(y, 1, 1e-3));

    /* I0(1) = 1.266 approx */
    ERE(ivi_bessel_I0(&y, 1));
    ERE(pretty_close(y, 1.266, 1e-3));

    /* I0(2) = 2.280 approx */
    ERE(ivi_bessel_I0(&y, 2));
    ERE(pretty_close(y, 2.28, 1e-3));

    /* I0(3) = 4.881 approx */
    ERE(ivi_bessel_I0(&y, 3));
